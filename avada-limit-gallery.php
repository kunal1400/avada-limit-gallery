...
function avada_limit_gallery_callback( $atts ) {
    ...
    if( is_user_logged_in() ) {
        ...
        if( count($images) > 0 ) {
            ...
            if( $formShortcode == "" ) {
                //$returnHtml .= '[fusion_button link="" text_transform="" title="" target="_self" link_attributes="" alignment="" modal="user_not_loged_in" hide_on_mobile="small-visibility,medium-visibility,large-visibility" class="" id="" color="default" button_gradient_top_color="" button_gradient_bottom_color="" button_gradient_top_color_hover="" button_gradient_bottom_color_hover="" accent_color="" accent_hover_color="" type="" bevel_color="" border_width="" size="" stretch="default" shape="" icon="" icon_position="left" icon_divider="no" animation_type="" animation_direction="left" animation_speed="0.3" animation_offset=""]Click Here to see all images[/fusion_button][fusion_modal name="user_not_loged_in" title="Sign Up" size="small" background="#1b1b1c" border_color="" show_footer="no" class="" id=""][fusion_register text_align="" form_field_layout="" heading="" heading_color="#ffffff" caption="Please login/signup to see all images" caption_color="" show_labels="no" show_placeholders="" button_fullwidth="" form_background_color="#1b1b1c" link_color="" register_note="" redirection_link="" hide_on_mobile="small-visibility,medium-visibility,large-visibility" class="" id="" ][/fusion_register][/fusion_modal]';
                $returnHtml .= '<form action="" method="post">
                    <div>
                        <label>Please enter your email</label>
                        <input type="text" name="avada_limit_gallery_user_registration_email">
                        <input type="hidden" name="avada_limit_gallery_redirect_url" value="'.$currentUrl.'">
                    </div>
